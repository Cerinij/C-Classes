...
void Student::Show() const
{
    cout << endl << "Имя: " << name
        << endl << "Возраст: " << age
        << endl << "Предмет: " << subject
        << endl << "Оценка: " << mark << endl;
}

void Student::CheckMark() const
{
    if (mark < 3) cout << "Оценка неудовлетворительная!" << endl;
    else cout << "Оценка удовлетворительная или выше." << endl;
}
